export type Language = "fr" | "en" | "es" | "de" | "it";
    ...
    "notification.variants.5.title": "✨ TarotMystik vous appelle",
   ...
   //Tirage love oracle
    ...
    // Card Names and Meanings - Love oracle - Tirage en croix
        ...
        "cards.lunar.intention.mindset.var1": "{name}, tu ressens le besoin de planter de nouvelles graines dans ta vie",
        "cards.lunar.intention.mindset.var2": "En ce moment, {name}, ton cœur est prêt à accueillir de nouveaux rêves",
        "cards.lunar.intention.mindset.var3": "Tu entres dans une phase où tout peut recommencer",
        "cards.lunar.intention.guidance.var1": "Clarifie ce que tu souhaites vraiment manifester.",
        "cards.lunar.intention.guidance.var2": "Pose une intention simple et sincère.",
        "cards.lunar.intention.guidance.var3": "Visualise ton intention comme déjà réalisée.",

        "cards.lunar.intuition.name": "Intuition",
        "cards.lunar.intuition.mindset.var1": "{name}, ton ressenti est particulièrement fort aujourd’hui",
        "cards.lunar.intuition.mindset.var2": "Une voix intérieure cherche à se faire entendre",
        "cards.lunar.intuition.mindset.var3": "Tu sais déjà ce qui est juste pour toi",
        "cards.lunar.intuition.guidance.var1": "Accorde-toi un moment de silence.",
        "cards.lunar.intuition.guidance.var2": "Fais confiance à tes premières impressions.",
        "cards.lunar.intuition.guidance.var3": "Ton intuition te guide avec bienveillance.",

        "cards.lunar.renouveau.name": "Renouveau",
        "cards.lunar.renouveau.mindset.var1": "Un nouveau cycle commence pour toi, {name}",
        "cards.lunar.renouveau.mindset.var2": "Le passé s’efface doucement",
        "cards.lunar.renouveau.mindset.var3": "Tu es prêt(e) à repartir sur de nouvelles bases",
        "cards.lunar.renouveau.guidance.var1": "Laisse derrière toi ce qui n’a plus lieu d’être.",
        "cards.lunar.renouveau.guidance.var2": "Accueille le changement avec confiance.",
        "cards.lunar.renouveau.guidance.var3": "Chaque fin porte en elle un nouveau départ.",
            //Premier Quartier
        "cards.lunar.motivation.name": "Motivation",
        "cards.lunar.motivation.mindset.var1": "{name}, une énergie nouvelle te pousse à agir",
        "cards.lunar.motivation.mindset.var2": "Ton élan intérieur se réveille",
        "cards.lunar.motivation.mindset.var3": "Tu ressens l’envie de faire avancer les choses",
        "cards.lunar.motivation.guidance.var1": "Canalise ton énergie vers un objectif clair.",
        "cards.lunar.motivation.guidance.var2": "Avance sans te juger.",
        "cards.lunar.motivation.guidance.var3": "Chaque pas compte, même le plus petit.",

        "cards.lunar.courage.name": "Courage",
        "cards.lunar.courage.mindset.var1": "{name}, tu as la force d’affronter ce qui se présente",
        "cards.lunar.courage.mindset.var2": "Le courage grandit à chaque défi relevé",
        "cards.lunar.courage.mindset.var3": "Tu es plus fort(e) que tu ne le crois",
        "cards.lunar.courage.guidance.var1": "Agis malgré les doutes.",
        "cards.lunar.courage.guidance.var2": "La peur n’est pas un frein, mais un passage.",
        "cards.lunar.courage.guidance.var3": "Fais confiance à ta résilience.",

        "cards.lunar.epanouissement.name": "Épanouissement",
        "cards.lunar.epanouissement.mindset.var1": "Tu avances vers plus d’harmonie, {name}",
        "cards.lunar.epanouissement.mindset.var2": "Tu te rapproches de ce qui te fait vibrer",
        "cards.lunar.epanouissement.mindset.var3": "Ton potentiel s’exprime naturellement",
        "cards.lunar.epanouissement.guidance.var1": "Nourris ce qui te fait du bien.",
        "cards.lunar.epanouissement.guidance.var2": "Accorde-toi le droit de grandir à ton rythme.",
        "cards.lunar.epanouissement.guidance.var3": "L’épanouissement naît de l’alignement intérieur.",
        //Pleine Lune  
        "cards.lunar.clarte.name": "Clarté",
        "cards.lunar.clarte.mindset.var1": "Les choses deviennent plus claires pour toi, {name}",
        "cards.lunar.clarte.mindset.var2": "Un voile se lève sur ta situation",
        "cards.lunar.clarte.mindset.var3": "Tu comprends enfin ce qui était confus",
        "cards.lunar.clarte.guidance.var1": "Utilise cette clarté pour faire des choix justes.",
        "cards.lunar.clarte.guidance.var2": "Fais confiance à ce que tu vois maintenant.",
        "cards.lunar.clarte.guidance.var3": "La vérité t’apporte l’apaisement.",

        "cards.lunar.serenite.name": "Sérénité",
        "cards.lunar.serenite.mindset.var1": "Une profonde paix intérieure t’enveloppe, {name}",
        "cards.lunar.serenite.mindset.var2": "Tu te sens en harmonie avec toi-même",
        "cards.lunar.serenite.mindset.var3": "Tout est à sa juste place",
        "cards.lunar.serenite.guidance.var1": "Savoure cet instant de calme.",
        "cards.lunar.serenite.guidance.var2": "Respire et relâche les tensions.",
        "cards.lunar.serenite.guidance.var3": "La sérénité est ton ancrage.",

        "cards.lunar.bilan.name": "Bilan",
        "cards.lunar.bilan.mindset.var1": "{name}, il est temps de reconnaître le chemin parcouru",
        "cards.lunar.bilan.mindset.var2": "Tu prends conscience de tes évolutions",
        "cards.lunar.bilan.mindset.var3": "Ce cycle t’a apporté des enseignements précieux",
        "cards.lunar.bilan.guidance.var1": "Célèbre tes progrès, même les plus discrets.",
        "cards.lunar.bilan.guidance.var2": "Tire les leçons de ton expérience.",
        "cards.lunar.bilan.guidance.var3": "Ce bilan t’aide à avancer avec sagesse.",
          //Dernier Quartier
        "cards.lunar.detachement.name": "Détachement",
        "cards.lunar.detachement.mindset.var1": "Il est temps de relâcher ce qui t’alourdit, {name}",
        "cards.lunar.detachement.mindset.var2": "Tu es prêt(e) à lâcher prise",
        "cards.lunar.detachement.mindset.var3": "Certaines choses n’ont plus besoin d’être retenues",
        "cards.lunar.detachement.guidance.var1": "Libère-toi sans culpabilité.",
        "cards.lunar.detachement.guidance.var2": "Le détachement ouvre un espace nouveau.",
        "cards.lunar.detachement.guidance.var3": "Fais confiance au mouvement de la vie.",

        "cards.lunar.prisederecul.name": "Prise de recul",
        "cards.lunar.prisederecul.mindset.var1": "{name}, observe ta situation avec plus de distance",
        "cards.lunar.prisederecul.mindset.var2": "Tu as besoin de temps pour comprendre",
        "cards.lunar.prisederecul.mindset.var3": "Le recul t’apporte de la lucidité",
        "cards.lunar.prisederecul.guidance.var1": "Ne prends pas de décision dans la précipitation.",
        "cards.lunar.prisederecul.guidance.var2": "Le calme clarifie les réponses.",
        "cards.lunar.prisederecul.guidance.var3": "Accorde-toi ce temps de réflexion.",
        
        "cards.lunar.retourasoi.name": "Retour à soi",
        "cards.lunar.retourasoi.mindset.var1": "Tu ressens le besoin de te recentrer, {name}",
        "cards.lunar.retourasoi.mindset.var2": "Ton monde intérieur appelle ton attention",
        "cards.lunar.retourasoi.mindset.var3": "Tu te reconnectes à ton essence",
        "cards.lunar.retourasoi.guidance.var1": "Prends soin de toi avec douceur.",
        "cards.lunar.retourasoi.guidance.var2": "Écoute tes besoins profonds.",
        "cards.lunar.retourasoi.guidance.var3": "Ce retour à toi est une force.",
    ...
    "interpretation.advice.var10":"Ton ange gardien te murmure de renforcer ta confiance en toi : elle ouvre les portes que tu attends depuis longtemps.",
      ...
      "interpretation.tarot.advice.var10":"accepte ce qui arrive et fonce, le moment est le bon.",
       ...
       // Pendule Divinatoire
        "pendulum.title": "Pendule Divinatoire",
        "pendulum.subtitle": "Posez votre question et laissez le pendule vous guider",
        "pendulum.askPrompt": "Posez votre question",
        "pendulum.questionPlaceholder": "Écrivez votre question ici...",
        "pendulum.closedQuestionHint": "Le pendule ne répond que par oui, non ou peut-être. Posez une question fermée pour obtenir une réponse claire.",
        "pendulum.submitQuestion": "Consulter le Pendule",
        "pendulum.thinking": "Le pendule se balance...",
        "pendulum.channeling": "Canalisation des énergies cosmiques...",
        "pendulum.yourQuestion": "Votre question",
        "pendulum.guidance": "Écoutez votre intuition pour interpréter ce message et trouvez votre propre vérité.",
        "pendulum.newQuestion": "Nouvelle Question",
        "pendulum.backHome": "Retour à l'accueil",
        "pendulum.disclaimer": "Les réponses du pendule sont symboliques et destinées au divertissement.",
        "pendulum.markers.yes": "OUI",
        "pendulum.markers.no": "NON",
        "pendulum.markers.maybe": "PEUT-ÊTRE",
        "pendulum.answers.yes": "Oui",
        "pendulum.answers.no": "Non",
        "pendulum.answers.maybe": "Peut-être",
        "pendulum.answers.veryLikely": "Très probable",
        "pendulum.answers.unlikely": "Peu probable",
        "pendulum.answers.certain": "C'est certain",
        "pendulum.answers.noChance": "Aucune chance",
        "pendulum.answers.askLater": "Demande plus tard",
        "pendulum.answers.dontCount": "N'y compte pas",
        "pendulum.answers.yesDefinitely": "Oui, absolument",
        "pendulum.answers.signsYes": "Les signes pointent vers oui",
        "pendulum.answers.signsNo": "Les signes pointent vers non",
        "pendulum.answers.unclear": "Pas clair pour le moment",
        "pendulum.answers.trustIntuition": "Fais confiance à ton intuition",
        "oracle.pendulum.title": "Pendule Divinatoire",
        "oracle.pendulum.description": "Le pendule divinatoire est un outil puissant pour obtenir des réponses claires à vos questions.",
        "pendulum.revelation": "Révélation mystique",
        "pendulum.messages.yes": "Les énergies sont alignées en votre faveur",
        "pendulum.messages.no": "Les astres conseillent la prudence",
        "pendulum.messages.maybe": "Les chemins restent encore incertains",
        "pendulum.messages.veryLikely": "Les signes sont fortement positifs",
        "pendulum.messages.unlikely": "Les forces s’y opposent actuellement",
        "pendulum.messages.certain": "La certitude émane du cosmos",
        "pendulum.messages.noChance": "Le destin indique une autre voie",
        "pendulum.messages.askLater": "Le moment n’est pas encore venu",
        "pendulum.messages.dontCount": "Ne comptez pas sur cette issue",
        "pendulum.messages.yesDefinitely": "Absolument, sans l’ombre d’un doute",
        "pendulum.messages.signsYes": "Tous les signes pointent vers l’affirmative",
        "pendulum.messages.signsNo": "Les présages sont défavorables",
        "pendulum.messages.unclear": "Le voile entre les mondes est trouble",
        "pendulum.messages.trustIntuition": "Écoutez votre voix intérieure",
  ...
  en: {
    ...
    "notification.variants.5.title": "✨ TarotMystik is calling you",
    ...
    //Carte Oracle Lunaire
    // 🌑 NEW MOON
    "cards.lunar.intention.name": "Intention",
    "cards.lunar.intention.mindset.var1": "{name}, you feel the need to plant new seeds in your life",
    "cards.lunar.intention.mindset.var2": "Right now, {name}, your heart is ready to welcome new dreams",
    "cards.lunar.intention.mindset.var3": "You are entering a phase where anything can start anew",
    "cards.lunar.intention.guidance.var1": "Clarify what you truly want to manifest.",
    "cards.lunar.intention.guidance.var2": "Set a simple and sincere intention.",
    "cards.lunar.intention.guidance.var3": "Visualize your intention as already fulfilled.",

    "cards.lunar.intuition.name": "Intuition",
    "cards.lunar.intuition.mindset.var1": "{name}, your feelings are especially strong today",
    "cards.lunar.intuition.mindset.var2": "An inner voice is trying to be heard",
    "cards.lunar.intuition.mindset.var3": "You already know what is right for you",
    "cards.lunar.intuition.guidance.var1": "Take a moment of silence.",
    "cards.lunar.intuition.guidance.var2": "Trust your first impressions.",
    "cards.lunar.intuition.guidance.var3": "Your intuition guides you with kindness.",

    "cards.lunar.renouveau.name": "Renewal",
    "cards.lunar.renouveau.mindset.var1": "A new cycle begins for you, {name}",
    "cards.lunar.renouveau.mindset.var2": "The past gently fades away",
    "cards.lunar.renouveau.mindset.var3": "You are ready to start fresh",
    "cards.lunar.renouveau.guidance.var1": "Leave behind what no longer serves you.",
    "cards.lunar.renouveau.guidance.var2": "Embrace change with confidence.",
    "cards.lunar.renouveau.guidance.var3": "Every ending carries a new beginning.",
    // 🌓 FIRST QUARTER
    "cards.lunar.motivation.name": "Motivation",
    "cards.lunar.motivation.mindset.var1": "{name}, a new energy pushes you to act",
    "cards.lunar.motivation.mindset.var2": "Your inner drive awakens",
    "cards.lunar.motivation.mindset.var3": "You feel the urge to move things forward",
    "cards.lunar.motivation.guidance.var1": "Channel your energy toward a clear goal.",
    "cards.lunar.motivation.guidance.var2": "Move forward without judgment.",
    "cards.lunar.motivation.guidance.var3": "Every step counts, even the smallest.",

    "cards.lunar.courage.name": "Courage",
    "cards.lunar.courage.mindset.var1": "{name}, you have the strength to face what comes your way",
    "cards.lunar.courage.mindset.var2": "Courage grows with each challenge overcome",
    "cards.lunar.courage.mindset.var3": "You are stronger than you think",
    "cards.lunar.courage.guidance.var1": "Act despite doubts.",
    "cards.lunar.courage.guidance.var2": "Fear is not a barrier, but a passage.",
    "cards.lunar.courage.guidance.var3": "Trust your resilience.",

    "cards.lunar.epanouissement.name": "Fulfillment",
    "cards.lunar.epanouissement.mindset.var1": "You are moving toward greater harmony, {name}",
    "cards.lunar.epanouissement.mindset.var2": "You are getting closer to what makes you vibrate",
    "cards.lunar.epanouissement.mindset.var3": "Your potential expresses itself naturally",
    "cards.lunar.epanouissement.guidance.var1": "Nourish what makes you feel good.",
    "cards.lunar.epanouissement.guidance.var2": "Allow yourself to grow at your own pace.",
    "cards.lunar.epanouissement.guidance.var3": "Fulfillment arises from inner alignment.",
    // 🌕 FULL MOON
    "cards.lunar.clarte.name": "Clarity",
    "cards.lunar.clarte.mindset.var1": "Things become clearer for you, {name}",
    "cards.lunar.clarte.mindset.var2": "A veil lifts over your situation",
    "cards.lunar.clarte.mindset.var3": "You finally understand what was confusing",
    "cards.lunar.clarte.guidance.var1": "Use this clarity to make fair choices.",
    "cards.lunar.clarte.guidance.var2": "Trust what you now see.",
    "cards.lunar.clarte.guidance.var3": "Truth brings you peace.",

    "cards.lunar.serenite.name": "Serenity",
    "cards.lunar.serenite.mindset.var1": "A deep inner peace envelops you, {name}",
    "cards.lunar.serenite.mindset.var2": "You feel in harmony with yourself",
    "cards.lunar.serenite.mindset.var3": "Everything is in its rightful place",
    "cards.lunar.serenite.guidance.var1": "Savor this moment of calm.",
    "cards.lunar.serenite.guidance.var2": "Breathe and release tension.",
    "cards.lunar.serenite.guidance.var3": "Serenity is your anchor.",

    "cards.lunar.bilan.name": "Assessment",
    "cards.lunar.bilan.mindset.var1": "{name}, it’s time to recognize the path you’ve taken",
    "cards.lunar.bilan.mindset.var2": "You become aware of your growth",
    "cards.lunar.bilan.mindset.var3": "This cycle has brought you valuable lessons",
    "cards.lunar.bilan.guidance.var1": "Celebrate your progress, even the small steps.",
    "cards.lunar.bilan.guidance.var2": "Learn from your experience.",
    "cards.lunar.bilan.guidance.var3": "This assessment helps you move forward wisely.",
    // 🌗 LAST QUARTER
    "cards.lunar.detachement.name": "Detachment",
    "cards.lunar.detachement.mindset.var1": "It’s time to release what weighs you down, {name}",
    "cards.lunar.detachement.mindset.var2": "You are ready to let go",
    "cards.lunar.detachement.mindset.var3": "Some things no longer need to be held",
    "cards.lunar.detachement.guidance.var1": "Free yourself without guilt.",
    "cards.lunar.detachement.guidance.var2": "Detachment opens new space.",
    "cards.lunar.detachement.guidance.var3": "Trust life’s flow.",

    "cards.lunar.prisederecul.name": "Perspective",
    "cards.lunar.prisederecul.mindset.var1": "{name}, observe your situation from a distance",
    "cards.lunar.prisederecul.mindset.var2": "You need time to understand",
    "cards.lunar.prisederecul.mindset.var3": "Stepping back brings clarity",
    "cards.lunar.prisederecul.guidance.var1": "Don’t make hasty decisions.",
    "cards.lunar.prisederecul.guidance.var2": "Calm clarifies the answers.",
    "cards.lunar.prisederecul.guidance.var3": "Give yourself this reflection time.",

    "cards.lunar.retourasoi.name": "Return to Self",
    "cards.lunar.retourasoi.mindset.var1": "You feel the need to center yourself, {name}",
    "cards.lunar.retourasoi.mindset.var2": "Your inner world calls for your attention",
    "cards.lunar.retourasoi.mindset.var3": "You reconnect with your essence",
    "cards.lunar.retourasoi.guidance.var1": "Take care of yourself gently.",
    "cards.lunar.retourasoi.guidance.var2": "Listen to your deep needs.",
    "cards.lunar.retourasoi.guidance.var3": "This return to yourself is a source of strength.",
    ...
    //Pendule divinatoire
    "pendulum.title": "Divinatory Pendulum",
    "pendulum.subtitle": "Ask your question and let the pendulum guide you",
    "pendulum.askPrompt": "Ask your question",
    "pendulum.questionPlaceholder": "Write your question here...",
    "pendulum.closedQuestionHint": "The pendulum only answers yes, no, or maybe. Ask a closed question for a clear response.",
    "pendulum.submitQuestion": "Consult the Pendulum",
    "pendulum.thinking": "The pendulum is swinging...",
    "pendulum.channeling": "Channeling cosmic energies...",
    "pendulum.yourQuestion": "Your question",
    "pendulum.guidance": "Listen to your intuition to interpret this message and discover your own truth.",
    "pendulum.newQuestion": "New Question",
    "pendulum.backHome": "Back Home",
    "pendulum.disclaimer": "Pendulum answers are symbolic and for entertainment purposes.",
    "pendulum.markers.yes": "YES",
    "pendulum.markers.no": "NO",
    "pendulum.markers.maybe": "MAYBE",
    "pendulum.answers.yes": "Yes",
    "pendulum.answers.no": "No",
    "pendulum.answers.maybe": "Maybe",
    "pendulum.answers.veryLikely": "Very likely",
    "pendulum.answers.unlikely": "Unlikely",
    "pendulum.answers.certain": "Certain",
    "pendulum.answers.noChance": "No chance",
    "pendulum.answers.askLater": "Ask later",
    "pendulum.answers.dontCount": "Don't count on it",
    "pendulum.answers.yesDefinitely": "Yes, definitely",
    "pendulum.answers.signsYes": "Signs point to yes",
    "pendulum.answers.signsNo": "Signs point to no",
    "pendulum.answers.unclear": "Unclear at the moment",
    "pendulum.answers.trustIntuition": "Trust your intuition",
    "oracle.pendulum.title": "Divinatory Pendulum",
    "oracle.pendulum.description": "The divinatory pendulum is a powerful tool to get clear answers to your questions.",
    "pendulum.revelation": "Mystical revelation",
    "pendulum.messages.yes": "The energies are aligned in your favor",
    "pendulum.messages.no": "The stars advise caution",
    "pendulum.messages.maybe": "The paths remain uncertain",
    "pendulum.messages.veryLikely": "The signs are strongly positive",
    "pendulum.messages.unlikely": "The forces currently oppose it",
    "pendulum.messages.certain": "Certainty emanates from the cosmos",
    "pendulum.messages.noChance": "Fate indicates another path",
    "pendulum.messages.askLater": "The time has not yet come",
    "pendulum.messages.dontCount": "Don’t count on this outcome",
    "pendulum.messages.yesDefinitely": "Absolutely, without a shadow of doubt",
    "pendulum.messages.signsYes": "All signs point to yes",
    "pendulum.messages.signsNo": "The omens are unfavorable",
    "pendulum.messages.unclear": "The veil between worlds is clouded",
    "pendulum.messages.trustIntuition": "Listen to your inner voice",
  ...
  es: {
    ...
    "notification.variants.5.title": "✨ TarotMystik te llama",
    ...
    //Pendule divinatoire
    "pendulum.title": "Péndulo Divinatorio",
    "pendulum.subtitle": "Haz tu pregunta y deja que el péndulo te guíe",
    "pendulum.askPrompt": "Haz tu pregunta",
    "pendulum.questionPlaceholder": "Escribe tu pregunta aquí...",
    "pendulum.closedQuestionHint": "El péndulo solo responde sí, no o tal vez. Haz una pregunta cerrada para obtener una respuesta clara.",
    "pendulum.submitQuestion": "Consultar el Péndulo",
    "pendulum.thinking": "El péndulo se balancea...",
    "pendulum.channeling": "Canalizando energías cósmicas...",
    "pendulum.yourQuestion": "Tu pregunta",
    "pendulum.guidance": "Escucha tu intuición para interpretar este mensaje y descubrir tu propia verdad.",
    "pendulum.newQuestion": "Nueva Pregunta",
    "pendulum.backHome": "Volver al inicio",
    "pendulum.disclaimer": "Las respuestas del péndulo son simbólicas y para entretenimiento.",
    "pendulum.markers.yes": "SÍ",
    "pendulum.markers.no": "NO",
    "pendulum.markers.maybe": "QUIZÁS",
    "pendulum.answers.yes": "Sí",
    "pendulum.answers.no": "No",
    "pendulum.answers.maybe": "Quizás",
    "pendulum.answers.veryLikely": "Muy probable",
    "pendulum.answers.unlikely": "Poco probable",
    "pendulum.answers.certain": "Cierto",
    "pendulum.answers.noChance": "Sin posibilidad",
    "pendulum.answers.askLater": "Pregunta más tarde",
    "pendulum.answers.dontCount": "No cuentes con ello",
    "pendulum.answers.yesDefinitely": "Sí, definitivamente",
    "pendulum.answers.signsYes": "Los signos indican sí",
    "pendulum.answers.signsNo": "Los signos indican no",
    "pendulum.answers.unclear": "No está claro por ahora",
    "pendulum.answers.trustIntuition": "Confía en tu intuición",
    "oracle.pendulum.title": "Péndulo Divinatorio",
    "oracle.pendulum.description": "El péndulo divinatorio es una herramienta poderosa para obtener respuestas claras a tus preguntas.",
    "pendulum.revelation": "Revelación mística",
    "pendulum.messages.yes": "Las energías están alineadas a tu favor",
    "pendulum.messages.no": "Los astros aconsejan prudencia",
    "pendulum.messages.maybe": "Los caminos siguen siendo inciertos",
    "pendulum.messages.veryLikely": "Las señales son muy positivas",
    "pendulum.messages.unlikely": "Las fuerzas se oponen en este momento",
    "pendulum.messages.certain": "La certeza emana del cosmos",
    "pendulum.messages.noChance": "El destino indica otro camino",
    "pendulum.messages.askLater": "Aún no es el momento",
    "pendulum.messages.dontCount": "No cuentes con este resultado",
    "pendulum.messages.yesDefinitely": "Absolutamente, sin ninguna duda",
    "pendulum.messages.signsYes": "Todas las señales apuntan al sí",
    "pendulum.messages.signsNo": "Los presagios son desfavorables",
    "pendulum.messages.unclear": "El velo entre los mundos está nublado",
    "pendulum.messages.trustIntuition": "Escucha tu voz interior",
  ...
  de: {
    ...
    "notification.variants.5.title": "✨ TarotMystik ruft dich",
    ...
    "interpretation.tarot.advice.var10":"akzeptiere, was kommt, und geh voran, der Moment ist günstig.",
      ...
      // Pendule Divinatoire
    "pendulum.title": "Divinatorisches Pendel",
    "pendulum.subtitle": "Stelle deine Frage und lass das Pendel dich führen",
    "pendulum.askPrompt": "Stelle deine Frage",
    "pendulum.questionPlaceholder": "Schreibe hier deine Frage...",
    "pendulum.closedQuestionHint": "Das Pendel antwortet nur mit Ja, Nein oder Vielleicht. Stelle eine geschlossene Frage für eine klare Antwort.",
    "pendulum.submitQuestion": "Pendel befragen",
    "pendulum.thinking": "Das Pendel schwingt...",
    "pendulum.channeling": "Kosmische Energien werden kanalisiert...",
    "pendulum.yourQuestion": "Deine Frage",
    "pendulum.guidance": "Höre auf deine Intuition, um diese Botschaft zu interpretieren und deine eigene Wahrheit zu finden.",
    "pendulum.newQuestion": "Neue Frage",
    "pendulum.backHome": "Zurück zur Startseite",
    "pendulum.disclaimer": "Die Antworten des Pendels sind symbolisch und dienen der Unterhaltung.",
    "pendulum.markers.yes": "JA",
    "pendulum.markers.no": "NEIN",
    "pendulum.markers.maybe": "VIELLEICHT",
    "pendulum.answers.yes": "Ja",
    "pendulum.answers.no": "Nein",
    "pendulum.answers.maybe": "Vielleicht",
    "pendulum.answers.veryLikely": "Sehr wahrscheinlich",
    "pendulum.answers.unlikely": "Wenig wahrscheinlich",
    "pendulum.answers.certain": "Gewiss",
    "pendulum.answers.noChance": "Keine Chance",
    "pendulum.answers.askLater": "Später fragen",
    "pendulum.answers.dontCount": "Nicht darauf zählen",
    "pendulum.answers.yesDefinitely": "Ja, auf jeden Fall",
    "pendulum.answers.signsYes": "Die Zeichen deuten auf Ja",
    "pendulum.answers.signsNo": "Die Zeichen deuten auf Nein",
    "pendulum.answers.unclear": "Zurzeit unklar",
    "pendulum.answers.trustIntuition": "Vertraue deiner Intuition",
    "oracle.pendulum.title": "Divinatorisches Pendel",
    "oracle.pendulum.description": "Das divinatorische Pendel ist ein mächtiges Werkzeug, um klare Antworten auf deine Fragen zu erhalten.",
    "pendulum.revelation": "Mystische Offenbarung",
    "pendulum.messages.yes": "Die Energien sind zu deinen Gunsten ausgerichtet",
    "pendulum.messages.no": "Die Sterne raten zur Vorsicht",
    "pendulum.messages.maybe": "Die Wege sind noch ungewiss",
    "pendulum.messages.veryLikely": "Die Zeichen sind sehr positiv",
    "pendulum.messages.unlikely": "Die Kräfte wirken derzeit dagegen",
    "pendulum.messages.certain": "Gewissheit strömt aus dem Kosmos",
    "pendulum.messages.noChance": "Das Schicksal weist auf einen anderen Weg",
    "pendulum.messages.askLater": "Die Zeit ist noch nicht gekommen",
    "pendulum.messages.dontCount": "Verlasse dich nicht auf dieses Ergebnis",
    "pendulum.messages.yesDefinitely": "Absolut, ohne jeden Zweifel",
    "pendulum.messages.signsYes": "Alle Zeichen deuten auf Ja",
    "pendulum.messages.signsNo": "Die Vorzeichen sind ungünstig",
    "pendulum.messages.unclear": "Der Schleier zwischen den Welten ist getrübt",
    "pendulum.messages.trustIntuition": "Höre auf deine innere Stimme",
  ...
  it: {
    ...
    "notification.variants.5.title": "✨ TarotMystik ti chiama",
    ...
    // Pendule Divinatoire
    "pendulum.title": "Pendolo Divinatorio",
    "pendulum.subtitle": "Fai la tua domanda e lascia che il pendolo ti guidi",
    "pendulum.askPrompt": "Fai la tua domanda",
    "pendulum.questionPlaceholder": "Scrivi qui la tua domanda...",
    "pendulum.closedQuestionHint": "Il pendolo risponde solo con sì, no o forse. Fai una domanda chiusa per ottenere una risposta chiara.",
    "pendulum.submitQuestion": "Consulta il Pendolo",
    "pendulum.thinking": "Il pendolo oscilla...",
    "pendulum.channeling": "Canalizzando energie cosmiche...",
    "pendulum.yourQuestion": "La tua domanda",
    "pendulum.guidance": "Ascolta la tua intuizione per interpretare questo messaggio e trovare la tua verità.",
    "pendulum.newQuestion": "Nuova Domanda",
    "pendulum.backHome": "Torna alla Home",
    "pendulum.disclaimer": "Le risposte del pendolo sono simboliche e a scopo di intrattenimento.",
    "pendulum.markers.yes": "SÌ",
    "pendulum.markers.no": "NO",
    "pendulum.markers.maybe": "FORSE",
    "pendulum.answers.yes": "Sì",
    "pendulum.answers.no": "No",
    "pendulum.answers.maybe": "Forse",
    "pendulum.answers.veryLikely": "Molto probabile",
    "pendulum.answers.unlikely": "Poco probabile",
    "pendulum.answers.certain": "Certamente",
    "pendulum.answers.noChance": "Nessuna possibilità",
    "pendulum.answers.askLater": "Chiedi più tardi",
    "pendulum.answers.dontCount": "Non contarci",
    "pendulum.answers.yesDefinitely": "Sì, assolutamente",
    "pendulum.answers.signsYes": "I segni indicano sì",
    "pendulum.answers.signsNo": "I segni indicano no",
    "pendulum.answers.unclear": "Non chiaro al momento",
    "pendulum.answers.trustIntuition": "Fidati della tua intuizione",
    "oracle.pendulum.title": "Pendolo Divinatorio",
    "oracle.pendulum.description": "Il pendolo divinatorio è uno strumento potente per ottenere risposte chiare alle tue domande.",
    "pendulum.revelation": "Rivelazione mistica",
    "pendulum.messages.yes": "Le energie sono allineate a tuo favore",
    "pendulum.messages.no": "Le stelle consigliano prudenza",
    "pendulum.messages.maybe": "I percorsi restano incerti",
    "pendulum.messages.veryLikely": "I segni sono fortemente positivi",
    "pendulum.messages.unlikely": "Le forze si oppongono in questo momento",
    "pendulum.messages.certain": "La certezza emana dal cosmo",
    "pendulum.messages.noChance": "Il destino indica un’altra strada",
    "pendulum.messages.askLater": "Non è ancora il momento",
    "pendulum.messages.dontCount": "Non fare affidamento su questo esito",
    "pendulum.messages.yesDefinitely": "Assolutamente, senza alcun dubbio",
    "pendulum.messages.signsYes": "Tutti i segni indicano sì",
    "pendulum.messages.signsNo": "I presagi sono sfavorevoli",
    "pendulum.messages.unclear": "Il velo tra i mondi è offuscato",
    "pendulum.messages.trustIntuition": "Ascolta la tua voce interiore",
